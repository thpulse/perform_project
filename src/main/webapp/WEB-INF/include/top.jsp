			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="top-navbar-1">
					<ul class="nav navbar-nav navbar-right">
						...
						<li>
							<div class="d1">
  								<form action="/project_final/search/searchResult.do">
  									<input type="text" placeholder="ÂƒÂ‰">
						...
						<li>
							<a href="/project_final/perform/prfinfo/index.do"><i class="fa fa-camera"></i><br>ê³µì—°ì •ë³´</a>
						</li>
						<li>
							<a href="/project_final/reservation/main.do"><i class="fa fa-comments"></i><br>ê³µì—°ì˜ˆë§¤</a>
						</li>
						<li>
							<a href="#"><i class="fa fa-tasks"></i><br>ê³µì—°2.0</a>
						</li>
						<li>
...
<<<<<<< HEAD
        					 ì•„ì´ë”” : <input id="login__username" type="text" class="form__input" placeholder="Username" required><br><br>
=======
        					
        					  ¾ÆÀÌµð : <input type="text" name="user_id" type="text" class="form__input" placeholder="Username" required><br><br>
>>>>>>> refs/remotes/origin/hyuns
        					 
<<<<<<< HEAD
     					 	  ë¹„ë°€ë²ˆí˜¸ : <input id="login__password" type="password" class="form__input" placeholder="Password" required>
     					 	</div>
=======
     					 	  ºñ¹Ð¹øÈ£ : <input type="password" name="user_pass" type="password" class="form__input" placeholder="Password" required>
     					 </div>
